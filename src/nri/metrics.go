...
var (
	...
	metricPlatform					  = metricFunc("platform", metric.ATTRIBUTE)
	...
	metricNumProcs					  = metricFunc("numProcs", metric.GAUGE)
	...
	metricMemoryCommit                = metricFunc("memoryCommit", metric.GAUGE)
	metricMemoryCommitPeak            = metricFunc("memoryCommitPeak", metric.GAUGE)
	metricMemoryPrivateWorkingSet     = metricFunc("memoryPrivateWorkingSet", metric.GAUGE)
	metricMemoryUsagePercent          = metricFunc("memoryUsagePercent", metric.GAUGE)
