...
var (
	...
	metricMemorySwapUsagePercent         = metricFunc("memorySwapUsagePercent", metric.GAUGE)
	...
	metricStorageDriverDataUsed          = metricFunc("StorageDriverDataUsedBytes", metric.GAUGE)
	metricStorageDriverDataAvailable     = metricFunc("StorageDriverDataAvailableBytes", metric.GAUGE)
	metricStorageDriverDataTotal         = metricFunc("StorageDriverDataTotalBytes", metric.GAUGE)
	metricStorageDriverMetadataUsed      = metricFunc("StorageDriverMetadataUsedBytes", metric.GAUGE)
	metricStorageDriverMetadataAvailable = metricFunc("StorageDriverMetadataAvailableBytes", metric.GAUGE)
	metricStorageDriverMetadataTotal     = metricFunc("StorageDriverMetadataTotalBytes", metric.GAUGE)
)
